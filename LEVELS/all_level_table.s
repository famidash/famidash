...
_level_lengths_lo:
  ...
  .byte .lobyte($0000B0)		; test
  .byte .lobyte($00006E)		; test2
  .byte .lobyte($0000B0)		; test3
  .byte .lobyte($0000B0)		; test4
...
_level_lengths_md:
  ...
  .byte .hibyte($0000B0)		; test
  .byte .hibyte($00006E)		; test2
  .byte .hibyte($0000B0)		; test3
  .byte .hibyte($0000B0)		; test4
...
_level_lengths_hi:
  ...
  .byte .bankbyte($0000B0)		; test
  .byte .bankbyte($00006E)		; test2
  .byte .bankbyte($0000B0)		; test3
  .byte .bankbyte($0000B0)		; test4
